...
#ch {
 ...
 overflow: hidden;
   ...
   <body>
   <div class="sidebar">
  <a href="index.html"  class="fa fa-home"><strong> Home - <img src="adminlogin/Capture.PNG" alt="LOGO"heigth='30'width='30'class='logo1'>
 </strong></a>
  <!-- <a href="#news">News</a>
  ...
  <a href="#about">About</a> -->
   ...
   <!-- <nav class="fixed-top">
    ...
    <br> -->
    <div class="container"id="ch"> <b><mark> YOUR FEEDBACK HISTORY </mark></b></div>
      <div class="container">
...
$hostForImage = "http://localhost/waste-management-system-main/phpGmailSMTP/upload/";
