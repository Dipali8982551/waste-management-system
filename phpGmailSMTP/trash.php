	...
	if( in_array($imageFileType,$extensions_arr) ){
	   ...
	   move_uploaded_file($image = $_FILES['file']['tmp_name'],$target_dir.$file);
    	...
    	if(mysqli_query($con,$sql)){
			$msg = '<div class = "alert alert-success"><span class="fa fa-check"> "Compain Registered Successfully!"</span><a href="http://localhost/waste-management-system-main/welcome.php"> view Complain </a></div>';
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="../reward_points.php">Earn Points</a></li>
